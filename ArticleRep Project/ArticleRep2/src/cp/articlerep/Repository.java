...
public class Repository {
	...
	public boolean insertArticle(Article a) {
		...
		byArticleId.singleLock(a.getId());
			...
			byAuthor.listLock(a.getAuthors());
			byKeyword.listLock(a.getKeywords());
			...
			byAuthor.listUnlock(a.getAuthors());
			byKeyword.listUnlock(a.getKeywords());
			byArticleId.singleUnlock(a.getId());
