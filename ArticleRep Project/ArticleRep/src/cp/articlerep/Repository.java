...
public class Repository {
	...
	public boolean insertArticle(Article a) {
		...
		byArticleId.singleWriteLock(a.getId());

			if (byArticleId.contains(a.getId())){
				byArticleId.singleWriteUnlock(a.getId());
				return false;
			}

			byAuthor.listWriteLock(a.getAuthors());
			byKeyword.listWriteLock(a.getKeywords());
			...
			byAuthor.listWriteUnlock(a.getAuthors());
			byKeyword.listWriteUnlock(a.getKeywords());
			byArticleId.singleWriteUnlock(a.getId());
	...
	public void removeArticle(int id) {
		byArticleId.singleWriteLock(id);

		Article a = byArticleId.get(id);

		if (a == null){
			byArticleId.singleWriteUnlock(id);
			return;
		}
	...
	public List<Article> findArticleByAuthor(List<String> authors) {
		...
		byAuthor.listReadUnlock(authors);
		return res;
	}
	...
	public List<Article> findArticleByKeyword(List<String> keywords) {
		...
		byKeyword.listReadLock(keywords);
		...
		byKeyword.listReadUnlock(keywords);
