...
// this hash table is implemented with Java's "synchronized" methods
public class SynchronizedHashTable<K, V> implements Map<K, V> {
	...
	public SynchronizedHashTable(int size) {
