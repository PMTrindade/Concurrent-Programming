...
// this hash table is implemented with an array of plain locks that lock each collision list
public class MediumGrainedPlainLocksHashTable<K, V> implements Map<K, V> {
	...
	public MediumGrainedPlainLocksHashTable(int size) {
